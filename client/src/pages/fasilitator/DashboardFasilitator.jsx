        ...
        <div className="grid-responsive-5" style={{ marginBottom: '24px', minWidth: '0' }}>
          {loading ? (
            ...
            <>
              ...
              <StatCard label="Pengajuan Izin" value={data?.izin_menunggu} color="#7c3aed" delay={3} icon={<IconFile />} onClick={() => navigate('/fasilitator/validasi-izin')} delta={data?.trends?.izin_menunggu_delta} />
        ...
        <div className="grid-responsive-3" style={{ gap: '16px' }}>
          ...
          <div className="card-animate card-animate-4" style={{ ...cardStyle, padding: 0, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: '16px 24px', borderTop: '1px solid #f1f5f9' }}>
              <button onClick={() => navigate('/fasilitator/validasi-izin')} style={{ fontSize: '13px', color: BRAND, fontWeight: '500', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>Lihat semua pengajuan →</button>
            </div>
          </div>
